...
import { CutiFormProps } from "./CutiForm";

interface PDFPreviewProps {
  data: CutiFormProps["data"];
}
  ...
  return (
    <Document>
      ...
      <View style={stylesEight.table}>
        ...
        <Text style={styles.header}>Keterangan:</Text>

        <Text style={{ marginBottom: "10px" }}>TTD Kepala</Text>
        <View style={styles.signatureBox}>
          <Image src={tandaTanganKepalaBase64} />
        </View>

        <View style={styles.signatureBox}>
          <Image src={tandaTanganBase64} />
        </View>

        <View style={styles.signatureBox}>
          <Image src={tandaTanganAtasanBase64} />
        </View>

        <View>
          <Text style={styles.header}>KAKI SURAT</Text>
          <Image src="/letter-footer.png" />
        </View>
      </Page>
    </Document>
  );
